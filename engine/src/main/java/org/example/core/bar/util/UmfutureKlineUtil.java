...
public class UmfutureKlineUtil {

    public static List<Bar> klines (UMFuturesClientImpl client, String symbol, KlineInterval interval, long statrTime, long endTime, long limit){
